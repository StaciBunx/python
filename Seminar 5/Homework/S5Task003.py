...
languages = list(map(lambda language: language.upper(),
                 ['python', 'c#', 'kotlin', 'java', 'c++', 'java_script']))
...
def swapped_numbers_languages(num_lan):
    filtered_list = []
    sum_ord = 0
...
print(swapped_numbers_languages(numbers_languages))
